 ...
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |Esc/Ctl| Num  | Alt  | GUI  |Lower | Space| Bksp | Raise| Left | Down |  Up  |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {CTL_T(KC_ESC), MO(_NUM), KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_ENT}
},
 ...
 * |-------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift |   ;  |   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |EntSft|
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |Esc/Ctl| Num  | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = {
