 ...
 * |-------+------+------+------+------+------+------+------+------+------+------+------|
 * |Esc/Ctl| Num  | Alt  | GUI  |Low/Nav|Space| Bksp |  Ent |Raise |CpyCut| Paste|1Pass |
 * `------------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {CTL_T(KC_ESC), TT(_NUM), KC_LALT, KC_LGUI, TD(TD_LOWER_NAV),   KC_SPC,  KC_BSPC,  KC_ENT,   RAISE, TD(TD_COPY_CUT), TD(TD_PASTE), TD(TD_ONE_PASSWORD)}
},
 ...
 * |      |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   [  |   ]  |   {  |   }  |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |)/Rsft|  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |ISO ~ |ISO | |      |      | Next |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      | Del  |      |      | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = {
  ...
  {KC_RSPC, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), _______, _______,  KC_MNXT},
  {_______, _______, _______, _______, _______, _______, KC_DEL, _______,    _______,    KC_VOLD, KC_VOLU, KC_MPLY}
},
